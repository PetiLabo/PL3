...
echo $page->afficher_head(_MODE_ADMIN);
echo $page->ouvrir_body(_MODE_ADMIN);

echo "<h1>Page "._PAGE_COURANTE." en mode administration</h1>\n";
...
echo $page->ecrire_body(_MODE_ADMIN);
echo "<h2><a href=\"../"._PAGE_COURANTE._SUFFIXE_PHP."\">Retour en mode normal</a></h2>\n";
echo $page->fermer_body(_MODE_ADMIN);
